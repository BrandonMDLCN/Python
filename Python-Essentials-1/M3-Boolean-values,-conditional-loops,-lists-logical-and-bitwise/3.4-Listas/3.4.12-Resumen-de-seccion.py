...
Nuevamente, aprenderás más sobre esto en el módulo 3.6 - no te preocupes. Por el momento, intenta experimentar con el código anterior y verifica cómo cambiarlo afecta la output.
