# Función que almacena nombre y calificación y las ordena al final
# Guarda la calificación en una tupla
#Saca promedio de todas las calificaciónes que tiene un alumno
school_class = {}
