...
# Pip's capabilities don't end here, but the command set we've presented to you is enough to start successfully managing packages that aren't a part of the regular Python 
# installation.
...
# Some say that one of the most important programming virtues is laziness. 
# Don't get us wrong – we don't want you to spend all day napping on the couch and dreaming of Python code.
